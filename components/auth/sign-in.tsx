                ...
                <div className="w-full">
                    <div className="rounded-3xl bg-white p-8 shadow-sm backdrop-blur sm:p-10">
                        ...
                        <form action={formAction} className="space-y-5" noValidate>
                            ...
                            {/* Email field */}
                            <div>
                                <FormLabel htmlFor="email" text="Email address" required={true} />
                                <div className="mt-2">
                                    <input id="email" name="email" type="email" autoComplete="email" className={`block w-full rounded-2xl border bg-white/70 px-4 py-3 text-sm text-zinc-900 placeholder-zinc-400 outline-none transition focus:ring-2 focus:ring-zinc-900/10 ${formState?.errors?.email?.length ? "border-red-300" : "border-zinc-200"}`} placeholder="you@example.com" />
                                </div>
                            ...
                            <div>
                                <div className="flex items-center justify-between">
                                    <FormLabel htmlFor="password" text="Password" required={true} />
                                    <TextLink text="Forgot password?" url="/forgot-password" />
                                </div>
                                <div className="mt-2">
                                    <input
                                        id="password"
                            ...
                            <div className="pt-2">
                                ...
                                <p className="mt-4 text-center text-xs text-zinc-500">Don&apos;t have an account?{" "}
                                    <TextLink text="Sign up" url="/sign-up" />
                                </p>
                            </div>
                        </form>
                    </div>
